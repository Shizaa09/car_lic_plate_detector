...
% Space for training loss curves image
\begin{figure}[H]
\centering
% \includegraphics[width=0.8\textwidth]{training_loss_curves.png}
\fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}Training Loss Curves Image\\[0.5cm]Placeholder for training loss visualization}}
...
% Space for webcam interface
\begin{figure}[H]
\centering
% \includegraphics[width=0.8\textwidth]{webcam_interface.png}
\fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}Webcam Interface\\[0.5cm]Placeholder for webcam interface screenshot}}
